...
//					print ("claim"+day);
					...
					PlayerPrefs.SetInt ("Coins",a+reward.reward);
				}
				else if (day == 2) {
					int a=PlayerPrefs.GetInt ("BallSizeUp");
					PlayerPrefs.SetInt ("BallSizeUp", a+reward.reward);
				}
				else if (day == 3) {
					int a=PlayerPrefs.GetInt ("NoGutter");
					PlayerPrefs.SetInt ("NoGutter",a+ reward.reward);
				}
				else if (day == 4) {
					int a=PlayerPrefs.GetInt ("twoPins");
					PlayerPrefs.SetInt ("twoPins",a+ reward.reward);
				}
				else if (day == 5) {
					int a=PlayerPrefs.GetInt ("TwoBalls");
					PlayerPrefs.SetInt ("TwoBalls",a+ reward.reward);
				}
				else if (day == 6) {
					int a=PlayerPrefs.GetInt ("GhostBall");
					PlayerPrefs.SetInt ("GhostBall",a+ reward.reward);
				}
				else if (day == 7) {
					int a=PlayerPrefs.GetInt ("Coins");
					PlayerPrefs.SetInt ("Coins",a+ reward.reward);
